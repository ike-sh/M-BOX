...
[![CI](https://github.com/ike-sh/M-BOX/actions/workflows/ci.yml/badge.svg)](https://github.com/ike-sh/M-BOX/actions/workflows/ci.yml)
...
![Rules & Config](docs/screenshots/rules.png)
...
- **Modern UI**: macOS Liquid Glass style panel, dark/light themes, English / 简体中文 (toggle in the top bar).
...
```bash
# backend (dev, no kernel management)
go run ./cmd/mbox -listen 127.0.0.1:8088 -manage=false
# frontend (proxies /api & /ws to :8088)
cd web && npm install && npm run dev   # http://localhost:5173

# production build
cd web && npm run build                # outputs web/dist
go build -o mbox ./cmd/mbox            # single binary; serves web/dist by default
```
