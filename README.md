...
| 仪表盘 | 规则与配置 |
| :---: | :---: |
| ![仪表盘](docs/screenshots/dashboard.png) | ![规则与配置](docs/screenshots/rules.png) |
| **节点管理** | **设置** |
| ![节点管理](docs/screenshots/proxies.png) | ![设置](docs/screenshots/settings.png) |
...
- **现代 UI**：macOS Liquid Glass 风格毛玻璃面板，暗/亮主题。
...
# 国内拉取慢可指定 GitHub 镜像：
# sudo EDGE_GH_MIRROR=https://你的镜像/https://github.com bash scripts/install.sh
```
